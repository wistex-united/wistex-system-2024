  ...
  else
  {
    ...
    switch(theSkillRequest.skill)
    {
      ...
      case SkillRequest::neuralControl:
        theNeuralControlSkill({.target = theRobotPose.inverse() * theSkillRequest.target.translation});
        break;
      case SkillRequest::neuralControlTraining:
        theNeuralControlTrainingSkill({.target = theRobotPose.inverse() * theSkillRequest.target.translation});
        break;
      default:
