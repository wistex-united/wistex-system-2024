...
SkillRequest SkillRequest::Builder::neuralControl()
{
  SkillRequest request;
...
SkillRequest SkillRequest::Builder::neuralControlTraining()
{
  SkillRequest request;
  request.skill = SkillRequest::neuralControlTraining;
  return request;
}
