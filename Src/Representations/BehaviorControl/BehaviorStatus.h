...
{,
  ...
  (int)(-1) policyIndex, /**< The index of the NeuralControl policy that the robot is using. */
  (int)(-1) onBallSkillIndex, /**< Whether the OnBall policy is calling theWalkAtRelativeSpeedSkill or theWalkToBallAndKickSkill etc.  */
});
